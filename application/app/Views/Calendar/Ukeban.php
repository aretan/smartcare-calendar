        ...
        <form role="form" method="POST" action="<?= site_url('calendar/ukeban') ?>">
          <div class="box-body">
            <div class="form-group<?=(!$validation->hasError('shoken_id'))?'': ' has-error' ?>">
              ...
              <input type="text" class="form-control" name="shoken_id" id="inputShokenId" placeholder="825-1234567" value="<?= set_value('shoken_id', $shoken_id) ?>" readonly>
            ...
            <div class="form-group<?=(!$validation->hasError('id'))?'': ' has-error' ?>">
              ...
              <input type="text" class="form-control" name="id" id="inputId" placeholder="E01-1908-1234567" value="<?= set_value('id') ?>">
